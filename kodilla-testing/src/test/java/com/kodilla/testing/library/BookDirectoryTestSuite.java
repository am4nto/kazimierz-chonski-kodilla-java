...
public class BookDirectoryTestSuite {
    ...
    public void testListBooksInHandsOf(){
        ...
        LibraryUser user1 = new LibraryUser("Marian", "Nowak", "80071134231");
        LibraryUser user2 = new LibraryUser("Onufry", "Oslinka", "12052845269");
        LibraryUser user3 = new LibraryUser("Ziuta", "Iksinska", "91011145269");

        when(libraryDatabaseMock.listBooksInHandsOf(user1)).thenReturn(resultListOf0Books);
        when(libraryDatabaseMock.listBooksInHandsOf(user2)).thenReturn(resultListOf1Book);
